...
enum class ClientTriggerType(
    ...
    APNPCU(8, subjectMode = SubjectMode.Type(ScriptVarType.NPC, global = false)),
    APNPCT(9, subjectMode = SubjectMode.Type(ScriptVarType.NPC, global = false)),
    ...
    OPNPCU(15, subjectMode = SubjectMode.Type(ScriptVarType.NPC, global = false)),
    OPNPCT(16, subjectMode = SubjectMode.Type(ScriptVarType.NPC, global = false)),
    ...
    AI_APNPCU(22, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_APNPCT(23, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    ...
    AI_OPNPCU(29, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_OPNPCT(30, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    ...
    APOBJU(36, subjectMode = SubjectMode.Type(ScriptVarType.NAMEDOBJ, global = false)),
    APOBJT(37, subjectMode = SubjectMode.Type(ScriptVarType.NAMEDOBJ, global = false)),
    ...
    OPOBJU(43, subjectMode = SubjectMode.Type(ScriptVarType.NAMEDOBJ, global = false)),
    OPOBJT(44, subjectMode = SubjectMode.Type(ScriptVarType.NAMEDOBJ, global = false)),
    ...
    AI_APOBJU(50, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_APOBJT(51, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    ...
    AI_OPOBJU(57, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_OPOBJT(58, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    ...
    APLOCU(64, subjectMode = SubjectMode.Type(ScriptVarType.LOC, global = false)),
    APLOCT(65, subjectMode = SubjectMode.Type(ScriptVarType.LOC, global = false)),
    ...
    OPLOCU(71, subjectMode = SubjectMode.Type(ScriptVarType.LOC, global = false)),
    OPLOCT(72, subjectMode = SubjectMode.Type(ScriptVarType.LOC, global = false)),
    ...
    AI_APLOCU(78, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_APLOCT(79, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    ...
    AI_OPLOCU(85, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_OPLOCT(86, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    ...
    APPLAYERU(92, subjectMode = SubjectMode.None),
    ...
    OPPLAYERU(99, subjectMode = SubjectMode.None),
    OPPLAYERT(100, subjectMode = SubjectMode.None),
    AI_APPLAYER1(101, subjectMode = SubjectMode.None),
    AI_APPLAYER2(102, subjectMode = SubjectMode.None),
    AI_APPLAYER3(103, subjectMode = SubjectMode.None),
    AI_APPLAYER4(104, subjectMode = SubjectMode.None),
    AI_APPLAYER5(105, subjectMode = SubjectMode.None),
    AI_APPLAYERU(106, subjectMode = SubjectMode.None),
    AI_APPLAYERT(107, subjectMode = SubjectMode.None),
    AI_OPPLAYER1(108, subjectMode = SubjectMode.None),
    AI_OPPLAYER2(109, subjectMode = SubjectMode.None),
    AI_OPPLAYER3(110, subjectMode = SubjectMode.None),
    AI_OPPLAYER4(111, subjectMode = SubjectMode.None),
    AI_OPPLAYER5(112, subjectMode = SubjectMode.None),
    AI_OPPLAYERU(113, subjectMode = SubjectMode.None),
    AI_OPPLAYERT(114, subjectMode = SubjectMode.None),

    WEAKQUEUE(115, allowParameters = true),
    QUEUE(116, allowParameters = true),
    AI_QUEUE1(117, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE2(118, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE3(119, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE4(120, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE5(121, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE6(122, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE7(123, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE8(124, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE9(125, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE10(126, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE11(127, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE12(128, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE13(129, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE14(130, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE15(131, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE16(132, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE17(133, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE18(134, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE19(135, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    AI_QUEUE20(136, subjectMode = SubjectMode.Type(ScriptVarType.NPC)),
    ...
    OPHELDU(145, subjectMode = SubjectMode.Type(ScriptVarType.NAMEDOBJ, global = false)),
    OPHELDT(146, subjectMode = SubjectMode.Type(ScriptVarType.NAMEDOBJ, global = false)),

    IF_BUTTON(147, subjectMode = SubjectMode.Type(ScriptVarType.COMPONENT)),
    IF_BUTTON1(148, subjectMode = SubjectMode.Type(ScriptVarType.COMPONENT)),
    IF_BUTTON2(149, subjectMode = SubjectMode.Type(ScriptVarType.COMPONENT)),
    IF_BUTTON3(150, subjectMode = SubjectMode.Type(ScriptVarType.COMPONENT)),
    IF_BUTTON4(151, subjectMode = SubjectMode.Type(ScriptVarType.COMPONENT)),
    IF_BUTTON5(152, subjectMode = SubjectMode.Type(ScriptVarType.COMPONENT)),
    IF_BUTTOND(153, subjectMode = SubjectMode.Type(ScriptVarType.COMPONENT)),
    ...
    MAPENTER(157, subjectMode = SubjectMode.None),
